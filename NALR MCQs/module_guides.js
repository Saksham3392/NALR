...
const MODULE_GUIDES = {
  ...
  "mod10": {
    ...
    "what_is_it": "Finding ages using four main patterns: ratio and past/future changes, sum/difference relations, product-based conditions, and multiple-person or advanced age relations.",
    ...
    "core_mechanics": [
      ...
      "3. For sum/difference questions, translate each statement into a linear equation.",
      "4. For product questions, combine the product condition with the given ratio or age relation.",
      "5. For multiple-person problems, define a common variable or average and connect all stated relationships."
    ],
    "diagram_html": "",
  ...
  "mod13": {
    ...
    "what_is_it": "Classification problems in which all but one item follow a common property. This uploaded set uses three main forms: single-letter classification, pair-based classification, and set/triple-based classification.",
    "real_world_use": "The uploaded ODD ONE OUT material defines three forms: Type-1 classification among words/people, Type-2 classification among pairs, and Type-3 odd one out among a set. The questions supplied here are alphabet-based versions of those three forms.",
    "core_mechanics": [
      "1. Type 1: compare the property shared by the single letters/items.",
      "2. Type 2: compare alphabet positions, gaps, order, or pair-wise relations.",
      "3. Type 3: identify the common positional pattern across the larger letter sets and select the exception."
    ],
    "diagram_html": "",
