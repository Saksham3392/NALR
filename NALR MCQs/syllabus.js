...
const SYLLABUS_DATA = {
...

  {
    ...
    types: [
      { id: "type_1", name: "Type 1: Ratio & Past/Future Age", desc: "Age-ratio questions where ages are compared across present, past, and future time points.", count: 10 },
      { id: "type_2", name: "Type 2: Sum/Difference & Age Relations", desc: "Problems using total or difference of ages together with direct age relationships.", count: 7 },
      { id: "type_3", name: "Type 3: Product-Based Age Problems", desc: "Problems involving the product of ages, usually combined with ratios or another age relation.", count: 4 },
      { id: "type_4", name: "Type 4: Multiple-Person & Advanced Age Problems", desc: "Problems involving three or more people, indirect age statements, averages, or combined age conditions.", count: 5 }
    ]
  },
    // -------------------------------------------------------------------------
...

  {
    ...
    desc: "Spotting the unique divergent element in letters, pairs, and letter sets.",
    types: [
      { id: "type_1", name: "Type 1: Single Letter Classification", desc: "Find the one letter that does not share the common classification with the others.", count: 2 },
      { id: "type_2", name: "Type 2: Pair-Based Classification", desc: "Identify the odd pair using alphabet positions, gaps, order, or combined properties.", count: 7 },
      { id: "type_3", name: "Type 3: Set/Triple-Based Classification", desc: "Find the odd three-letter set by detecting the common positional pattern followed by the other sets.", count: 18 }
    ]
  },
    // -------------------------------------------------------------------------
